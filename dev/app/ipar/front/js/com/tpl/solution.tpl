<div class="solution entity" data-id="{{dst_eid}}" data-type="{{dst_type_id}}">
    ...
    <div class="entity-info">
        ...
        <span class="item property-id-{{id}}" data-pid="{{id}}">
            <a class="solution-vote" href="javascript:;">
                <i class="icon icon-vote {{is_vote}}"></i>
                <span class="text">{{vote_text}}</span>
            </a>
            <a class="solution-vote-count" href="javascript:;">
                {{vote_count}}
            </a>
        </span>
        ...
        <div class="comments-container" data-comments-count={{entity_comments_count}}>
            ...
            <div class="comment-action">
                <form class="comment-form">
                    ...
                    <textarea rows="1" type="text" name="content" required="required"
                              class="comment-textbox input-group-field"></textarea>
