...
class ArticleCommentController extends \Gap\Routing\Controller
{
    ...
    public function LatestPost()
    {
        ...
        $comment_set = $this->service('article_comment')->search($query);
    ...
    {
        $query = [
            'article_id' => $this->request->request->get('dst_id'),
    ...
    public function createPost()
    {
        ...
        $data['article_id'] = $this->request->request->get('dst_id');
        ...
        if ($reply_id && $reply_uid) {
            ...
            $reply_comment = $this->service('article_comment')->findCommentById($reply_id);
            $data['opts']['conv'] = $reply_comment->conv;
        }

        $pack = $this->service('article_comment')->createComment($data);
    ...
    public function deletePost()
    {
        ...
        $comment = $this->service('article_comment')->findCommentById($comment_id);
