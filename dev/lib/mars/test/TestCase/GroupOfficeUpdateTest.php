...
class GroupOfficeUpdateTest extends \Gap\Database\Test\DatabaseTestCase
{
    public function getDataSet()
    {
        return $this->createFlatXMLDataSet(dirname(__FILE__) . '/data/group-office-update-init.xml');
    }
    ...
    public function testUpdate()
    {
        ...
        $pack = $group_office_repo->update(['gid' => 1], [
            'gid' => 1,
            'name' => 'kuipukeji',
        ...
        $expected_table = $this->createFlatXMLDataSet(dirname(__FILE__) . '/data/group-office-update-expected.xml')
