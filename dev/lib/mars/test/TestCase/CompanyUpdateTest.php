...
class CompanyUpdateTest extends \Gap\Database\Test\DatabaseTestCase
{
    public function getDataSet()
    {
        return $this->createFlatXMLDataSet(dirname(__FILE__) . '/data/company-update-init.xml');
    }
    ...
    public function testUpdate()
    {
        ...
        $pack = $company_repo->update($query, $data);
        ...
        if ($pack->isOk()) {
            ...
            $expected_table = $this->createFlatXMLDataSet(dirname(__FILE__) .
                '/data/company-update-expected.xml')->getTable('company');
            ...
            $expected_table = $this->createFlatXMLDataSet(dirname(__FILE__) .
                '/data/company-update-expected.xml')->getTable('group');
            $this->assertTablesEqual($expected_table, $query_table);
        }
    }
